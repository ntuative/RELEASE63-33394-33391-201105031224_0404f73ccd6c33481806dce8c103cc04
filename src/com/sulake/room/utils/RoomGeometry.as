package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_961:Number = 64;
      ...
      private var var_1280:Vector3d;
      
      private var var_454:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1279:Vector3d;
      ...
      private var var_2021:Number = 1.0;
      
      private var var_2023:Number = 1.0;
      
      private var var_2022:Number = 1.0;
      
      private var var_90:Vector3d;
      
      private var var_455:Vector3d;
      
      private var var_2973:Number = -500.0;
      
      private var var_2972:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1280 = new Vector3d();
         this.var_454 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1279 = new Vector3d();
         this.var_2021 = 1;
         this.var_2023 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2022 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_454.assign(this.var_90);
         this.var_454.x *= this.var_453;
         this.var_454.y *= this.var_456;
         this.var_454.z *= this.var_457;
         return this.var_454;
      }
      ...
      {
         if(this.var_453 != param1 * this.var_2021)
         {
            this.var_453 = param1 * this.var_2021;
            ++this.var_170;
         }
      }
      ...
      {
         if(this.var_456 != param1 * this.var_2023)
         {
            this.var_456 = param1 * this.var_2023;
            ++this.var_170;
         }
      }
      ...
      {
         if(this.var_457 != param1 * this.var_2022)
         {
            this.var_457 = param1 * this.var_2022;
            ++this.var_170;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_90.x /= this.var_453;
         this.var_90.y /= this.var_456;
         this.var_90.z /= this.var_457;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1280.assign(this.var_152);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_547 != null)
         {
            ...
            this.var_547.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_547.add(_loc3_,_loc4_);
            ++this.var_170;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_547 != null)
         {
            ...
            return this.var_547.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1279.assign(_loc22_);
         }
         else
         {
            this.var_1279.assign(_loc17_);
         }
         ++this.var_170;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_453;
         _loc2_.y *= this.var_456;
         _loc2_.z *= this.var_457;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1279);
         if(_loc3_ < this.var_2973 || _loc3_ > this.var_2972)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_456;
            _loc2_.z *= this.var_457;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1279);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_90.x * this.var_453,this.var_90.y * this.var_456,this.var_90.z * this.var_457);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_152;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_453,param2.y * this.var_456,param2.z * this.var_457);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_453,param3.y * this.var_456,param3.z * this.var_457);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_453,param4.y * this.var_456,param4.z * this.var_457);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_961;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_961;
      }
