package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectSortableSpriteCacheItem
   {
      ...
      {
         if(param1 != this.var_2534 || param2 != this.var_2533)
         {
      ...
      public function setSpriteCount(param1:int) : void
      {
         ...
         if(param1 < this.var_199.length)
         {
            ...
            this.var_199.splice(param1,this.var_199.length - param1);
         }
         if(this.var_199.length == 0)
         {
            this.var_1820 = true;
         }
         else
