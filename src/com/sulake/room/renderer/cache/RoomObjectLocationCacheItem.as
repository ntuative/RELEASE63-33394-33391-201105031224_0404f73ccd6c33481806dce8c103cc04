package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      private var var_343:Vector3d = null;
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1706 || param1.getUpdateID() != this.var_2322)
         {
            this.var_2322 = param1.getUpdateID();
            if(param2.updateId != this.var_1706 || _loc4_.x != this.var_1124.x || _loc4_.y != this.var_1124.y || _loc4_.z != this.var_1124.z)
            {
         ...
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_343.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_343.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_343.x = Math.round(this.var_343.x);
            this.var_343.y = Math.round(this.var_343.y);
         }
         return this.var_343;
      }
   }
