package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_350:IRoomObject;
      
      private var var_710:IGraphicAssetCollection;
      
      protected var var_471:int = -1;
      
      protected var var_173:int = -1;
      
      protected var var_87:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_199.length > 0)
            {
               _loc1_ = this.var_199[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_710.removeReference();
         }
         this.var_710 = param1;
         if(this.var_710 != null)
         {
            this.var_710.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_199.length > param1)
         {
            _loc2_ = this.var_199[this.var_199.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
