package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_723,RoomWidgetEcotronBoxOpenMessage.const_927,RoomWidgetEcotronBoxOpenedMessage.const_1729];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_723:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_927:
