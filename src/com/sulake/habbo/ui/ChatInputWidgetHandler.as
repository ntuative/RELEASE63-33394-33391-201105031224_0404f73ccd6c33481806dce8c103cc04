package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_747);
         _loc1_.push(RoomWidgetChatTypingMessage.const_978);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_747:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_978:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1211,HabboToolbarIconEnum.CHATINPUT,param1));
      }
