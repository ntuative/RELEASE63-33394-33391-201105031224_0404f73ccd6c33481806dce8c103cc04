package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1557:IMessageEvent;
      
      private var var_2024:IMessageEvent;
      
      private var var_2025:IMessageEvent;
      ...
      {
         this.var_1557 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2024 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2025 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1557);
         this._connection.addMessageEvent(this.var_2024);
         this._connection.addMessageEvent(this.var_2025);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1557);
               this._connection.removeMessageEvent(this.var_2024);
               this._connection.removeMessageEvent(this.var_2025);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_739,RoomWidgetPlayListModificationMessage.const_942,RoomWidgetPlayListModificationMessage.const_941,RoomWidgetPlayListPlayStateMessage.const_722,RoomWidgetPlayListUserActionMessage.const_880];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_739:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_898,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_942:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_941:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_722:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_880:
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_718,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_763));
               break;
