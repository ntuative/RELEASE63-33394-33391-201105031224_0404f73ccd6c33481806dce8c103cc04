package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1342:String = "Default";
      
      private static const const_1341:int = 2;
      
      private static const const_1340:String = AvatarSetType.const_35;
      ...
      protected var var_282:IActiveActionData;
      ...
      protected var var_672:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1340,const_1341);
         this.var_329 = new Array();
         this.var_908 = new ActiveActionData(AvatarAction.const_445);
         this.var_908.definition = this._structure.getActionDefinition(const_1342);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_672,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1687;
         if(param2 < AvatarDirectionAngle.const_1147)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_600,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_248.length == 1 && this.var_88 == this.var_1995)
         {
            return this.var_88 + this.var_495 + this.var_600 % 4;
         }
         if(this.var_248.length == 2)
         {
            for each(_loc1_ in this.var_248)
            {
               ...
               {
                  return this.var_88 + this.var_495 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_600 % 11;
                  return this.var_88 + "_" + this.var_1995 + this.var_495 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2268 || param2 != this.var_2270 || param1 != this.var_2269)
         {
            this.var_2268 = param3;
            this.var_2270 = param2;
            this.var_2269 = param1;
            this.var_1686 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_282.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1336 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1336)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_282.definition.geometryType,this.var_88);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_600);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_282.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_282.definition.geometryType,this.var_88);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_600);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_329.push(new ActiveActionData(param1,param2,this.var_600));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_282 = this.var_908;
         this.var_282.definition = this.var_908.definition;
         this.resetBodyPartCache(this.var_908);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_495 = "";
         this.var_248 = this._structure.sortActions(this.var_329);
         if(this.var_248 == null)
         {
            this.var_793 = new Array(0,0,0);
            if(this.var_1386 != "")
            {
               _loc1_ = true;
               this.var_1386 = "";
         ...
         {
            this.var_793 = this._structure.getCanvasOffsets(this.var_248,this._scale,this.var_88);
            for each(_loc4_ in this.var_248)
            {
               this.var_495 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_327)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1387 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1387 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1386 != this.var_495)
            {
               _loc1_ = true;
               this.var_1386 = this.var_495;
            }
         }
         this.var_1385 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_248)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_907 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_199 = this.var_199.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1687 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_363 || _loc1_.actionType == AvatarAction.const_238 || _loc1_.actionType == AvatarAction.const_410)
               {
                  this.var_907 = true;
               }
            }
