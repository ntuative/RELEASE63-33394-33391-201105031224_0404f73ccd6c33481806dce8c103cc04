package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1326:IWindowContainer;
      
      public static var var_1609:IWindowContainer;
      
      public static var var_2129:int = 6710886;
      ...
      private var var_336:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_483:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1092 = [];
         this.var_1355 = [AvatarEditorFigureCategory.const_923,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_267,AvatarEditorFigureCategory.const_963,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_116];
         super();
         ...
         if(var_1326 == null)
         {
            ...
            var_1326 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1609 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1609 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_408 = new Timer(1000);
         this.var_408.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1355;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_408.stop();
            this.var_408.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_408 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1355);
         }
         if(param1.length != this.var_1092.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2162 = this.canChangeOutfit();
            this.var_408.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_336 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_336.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_336.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1092.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_336.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_336.numSelectables)
               {
                  this.var_336.getSelectableAt(_loc6_).x = this.var_336.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_336.setSelected(this.var_336.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1355;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1628 == AvatarEditorSideCategory.const_116 || this.var_2161))
         {
      ...
      {
         if(this.var_1628 == AvatarEditorSideCategory.const_116)
         {
            this.var_2161 = false;
            this.setSideContent(AvatarEditorSideCategory.const_789);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_789:
               break;
            ...
            case AvatarEditorSideCategory.const_116:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_116);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_367 = param1;
         this.var_336.setSelected(this.var_336.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2163 = new Date().valueOf();
                  this.var_2162 = false;
                  this.var_408.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_483)
         {
            ...
            this.var_483 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_483.procedure = this.stripClubDialogEventProc;
            this.var_483.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2163 > 5000;
      }
   }
}
