package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_677:String = "tab_boy";
      
      private const const_678:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_67.controller.gender)
         {
            case FigureData.const_82:
               activateTab(this.const_677);
               inactivateTab(this.const_678);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_678);
               inactivateTab(this.const_677);
         }
      }
