package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2051:Number = 1.0;
      
      private var var_2050:Number = 1.0;
      
      private var var_2053:Number = 1.0;
      ...
      {
         super();
         this.var_1951 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2740 = parseInt(_loc2_,16);
         this.var_2739 = parseInt(_loc3_,16);
         ...
         this.var_731 = new ColorTransform(this.var_2051,this.var_2050,this.var_2053,this._alphaMultiplier);
         this.var_1248 = this.generatePaletteMapForGrayscale(this.var_2739,this.var_2740);
      }
