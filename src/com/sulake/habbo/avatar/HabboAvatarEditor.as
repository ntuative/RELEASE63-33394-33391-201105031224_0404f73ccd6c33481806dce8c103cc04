package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1522:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1523:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1320:AvatarEditorHandler;
      ...
      private var var_1067:IFigureData;
      
      private var var_697:Dictionary;
      ...
      private var var_1603:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_1021 = FigureData.const_82;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_195)
         {
            this.var_697 = new Dictionary();
            this.var_697["null"] = new FigureData(this);
            this.var_697["null"] = new FigureData(this);
            _loc2_ = this.var_697["null"];
            _loc3_ = this.var_697["null"];
            _loc2_.loadAvatarData(const_1522,FigureData.const_82);
            _loc3_.loadAvatarData(const_1523,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_565 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_923,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_267,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_963,new LegsModel(this));
            ...
            this.var_565.add(AvatarEditorSideCategory.const_116,new WardrobeModel(this));
            this.var_565.add(AvatarEditorSideCategory.const_480,new ClubPromoModel(this));
            this.var_195 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_697[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1067.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1067.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_281 == null)
            {
               this.var_281 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_73,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_281.addChild(this._view.window);
               if(param5)
               {
                  this.var_281.center();
               }
            ...
            this.var_281.visible = !this.var_281.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_923);
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_566 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_1067 = this.var_566.getFigureData(AvatarType.const_127);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1320 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_697[this.var_1021];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1603 != null)
         {
            ...
            this.var_1603.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2088;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1321 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1524)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1609.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_566.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_566.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1326.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1648)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1321 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1326.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1321 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_565.getValue(AvatarEditorSideCategory.const_116);
      }
