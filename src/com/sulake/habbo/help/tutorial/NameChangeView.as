package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_807)
         {
            this.var_807 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_807)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_808)
         {
            this.var_808 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_808)
            {
               return;
            }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_97);
         }
      }
