package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_1513:WelcomeNotification;
      ...
      public function dispose() : void
      {
         if(this.var_118)
         {
            ...
            this.var_118.toolbar.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
            this.var_118.toolbar.events.removeEventListener(HabboToolbarEvent.const_785,this.onToolbarResized);
            this.var_118 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_118.toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
         this.var_118.toolbar.events.addEventListener(HabboToolbarEvent.const_785,this.onToolbarResized);
         ...
         this.var_211.y = this.var_118.toolbar.getIconLocation(param1.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_104,this.var_1513.targetIconId);
      ...
      private function onToolbarResized(param1:HabboToolbarEvent) : void
      {
         ...
         this.var_211.y = this.var_118.toolbar.getIconLocation(this.var_1513.targetIconId) - this._window.height / 2;
      }
