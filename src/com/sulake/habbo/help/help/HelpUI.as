package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105031217));
         this._toolbar = param5;
         this.var_116 = new Map();
         this.var_116.add(HabboHelpViewEnum.const_1771,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_204,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_593,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_347,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_284,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_383,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_807,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_272,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_116.add(HabboHelpViewEnum.const_1113,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_116.add(HabboHelpViewEnum.const_1227,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_914,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_518.length == 0 || param1 != this.var_367)
            {
               this.var_518.push(this.var_367);
            }
         }
         this.var_367 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_272:
               this.showUI(HabboHelpViewEnum.const_272);
               break;
            case CallForHelpResultEnum.const_1124:
               this.showUI(HabboHelpViewEnum.const_1227);
               break;
            case CallForHelpResultEnum.const_1273:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_116.getValue(HabboHelpViewEnum.const_204) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_530));
      }
      ...
      {
         return this.var_116.getValue(this.var_367);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2501 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2502;
         this._window.width = _loc1_.width + this.var_2501;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_518.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_204)
         {
            return;
         }
         if(this.var_641.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_641.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_641[1],this.var_641[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_641[0],this.var_641[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_204 || this.var_518.length == 0)
         {
            return;
         }
         if(this.var_366 == null)
