package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1208:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1208.volume);
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1208.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_776 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_776.width,this.var_776.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_776,this.var_776.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_775 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_775.width,this.var_775.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_775,this.var_775.rect,new Point(0,0),null,null,true);
