package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_419:IFrameWindow;
      ...
      private const const_2128:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_347 = new Timer(this.const_2128);
         this.var_347.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1132.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_500);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1132.getValue(this.var_500) as CommandConfiguration;
      ...
      {
         this.var_1132.remove(param1);
         this.var_1132.add(param1,param2);
         if(param1 != this.var_500)
         {
            return;
         }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_976,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.position = DEFAULT_LOCATION;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_419 == null)
         {
            ...
            this.var_419 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_419 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_419.x = 200;
            this.var_419.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_417,this.var_500));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_483,this.var_500,this.var_1719 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_483,this.var_500,this.var_1719 + " " + _loc5_);
