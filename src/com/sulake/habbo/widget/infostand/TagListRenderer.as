package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2126:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_163:Function;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            this._offsetX = 0;
            this.var_1128 += param1.height + this.const_2126;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1128);
         this._offsetX += param1.width + this.const_2125;
         return true;
      }
      ...
      private function createTag(param1:String) : ITextWindow
      {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_163);
