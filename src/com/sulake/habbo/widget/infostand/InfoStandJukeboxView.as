package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_440)
         {
            this.var_1730 = param1.songId;
         }
         if(param1.songId == this.var_1730)
         {
            this._songName = param1.songName;
            this.var_2363 = param1.songAuthor;
            this.updateNowPlaying(this.var_1730 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2363;
         }
         else
         {
