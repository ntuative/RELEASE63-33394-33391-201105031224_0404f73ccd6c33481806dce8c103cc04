package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1451:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1450:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_822,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_758,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_822,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_758,this.onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2472 = param1.presetId;
         this.var_1229 = param1.effectId;
         ...
         if(!this.validateBrightness(this.var_1228,this.var_1229))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1228,this.var_1229 == 2);
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1228,this.var_1229 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
