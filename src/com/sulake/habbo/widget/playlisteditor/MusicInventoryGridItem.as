package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridItem
   {
      ...
      private static const const_1429:uint = 14612159;
      ...
      private var var_2655:IContainerButtonWindow = null;
      ...
      private function createWindow() : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_2655 = _loc2_.getChildByName("button_to_playlist") as IContainerButtonWindow;
         }
         ...
         this.playButtonState = const_473;
      }
