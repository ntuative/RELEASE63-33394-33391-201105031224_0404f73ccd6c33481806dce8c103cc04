package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_906:String = "PLSV_ADD_SONGS";
      
      public static const const_1222:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_44 != const_527)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_432[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_432[const_906];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_432.add(const_527,_loc1_);
