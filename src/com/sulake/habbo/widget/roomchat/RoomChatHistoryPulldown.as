package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1003:int = 3;
      
      public static const const_590:int = 2;
      
      public static const const_418:int = 1;
      
      public static const const_298:int = 0;
      
      public static const const_86:int = 39;
      
      private static const const_1053:int = 150;
      ...
      private var var_2724:BitmapData;
      ...
      private var var_2725:BitmapData;
      
      private var var_2726:BitmapData;
      
      private var var_2721:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_42 = param3;
         this.var_2724 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1942 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2723 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1944 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1943 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2725 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2726 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_75 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_365,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_86),null,0,0) as IBitmapWrapperWindow;
         this.var_42.addChild(this.var_75);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_73,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_42.height - const_86,param3.width,const_86),null,0) as IWindowContainer;
         this.var_42.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_646,HabboWindowStyle.const_44,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_86),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_590:
               this.var_75.blend += param1 / const_1054;
               ...
               break;
            case const_1003:
               this.var_75.blend -= param1 / const_1053;
               this._window.blend -= param1 / const_1053;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_418:
               if(this._state == const_298)
               {
                  this.state = const_590;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_42.height - const_86;
            this._window.width = this.var_42.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_42.height - const_86;
            this._region.width = this.var_42.width - this.var_2721;
         }
         if(this.var_75 != null)
         {
            this.var_75.rectangle = this.var_42.rectangle;
            this.var_75.height -= const_86;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2722 == this._window.width)
         {
            return;
         }
         this.var_2722 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2723;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1944;
            _loc2_.disposesBitmap = false;
            this.var_2721 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2724,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1942,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1942,_loc9_);
         ...
         this.var_75.bitmap = this.var_2726;
