package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1530:String = "pixelbalance";
      
      private static const const_1526:String = "badges";
      
      private static const const_1527:String = "selectbadge";
      
      private static const const_1525:String = "inventory";
      
      private static const const_1531:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1532:String = "friendlist";
      
      private static const const_1529:String = "pet_inventory";
      
      private static const const_1528:String = "go_to_room";
      ...
      private var var_860:IHabboToolbar;
      ...
      private var var_397:HabboNotificationViewManager;
      
      private var var_237:HabboAlertDialogManager;
      
      private var var_859:ParkBusDialogManager;
      
      private var var_2911:Boolean;
      
      private var var_1069:ClubGiftNotification;
      
      private var var_1071:ClubEndingNotification;
      
      private var var_1070:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1840 = false;
         this.var_1608 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1068);
         }
         var _loc6_:Map = this.var_1068["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_860)
         {
            this.var_860.release(new IIDHabboToolbar());
            this.var_860 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1068["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_860 = IHabboToolbar(param2);
         this.var_860.events.addEventListener(HabboToolbarEvent.const_72,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_72)
         {
            ...
            this.var_397 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1068["styles"],this.var_1068["view"],this.var_860);
            ...
            registerUpdateReceiver(this.var_397,1);
            registerUpdateReceiver(this,2);
            this.var_388.events.addEventListener(BadgeImageReadyEvent.const_167,this.onBadgeImage);
            this.var_860.events.addEventListener(HabboToolbarEvent.const_632,this.onToolbarRepositionEvent);
         }
      }
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_397)
         {
            this.var_397.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1608[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_388);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1608[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1608[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_388.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1088,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1088,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1807,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_909,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_566.createAvatarImage(param2,AvatarScaleType.const_55);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_388.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_65)
               {
                  _loc7_ = this.var_388.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_388.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1783,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1280)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1533,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1668)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1071 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1070 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_397.isSpaceAvailable() && this.var_1322.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_397.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1529:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_147);
               }
               break;
            case const_1531:
               break;
      ...
      {
         if(param1 != null && this.var_397 != null)
         {
            this.var_397.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_859 == null)
         {
            this.var_859 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_859 != null)
         {
            this.var_859.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1237,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1237,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_566.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_55);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2911)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_909,null);
            this.var_2911 = true;
      ...
      {
         if(param2.type == WindowEvent.const_185 || param2.type == WindowEvent.const_547)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1069 && this.var_1069.visible)
         {
            return;
         }
         this.var_1069 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_909,_loc6_);
      }
   }
}
