package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1044:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1432:String = "sendAccessTokenToServer";
      
      private static const const_1431:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1432,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1431,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1044);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1044);
         }
      }
