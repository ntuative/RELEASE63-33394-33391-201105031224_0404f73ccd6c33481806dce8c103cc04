package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      {
         if(this._initialized && this.var_2846)
         {
            return true;
         }
         return false;
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_2044)
         {
            this.gotoRoom(this.var_2847,this.var_2845,this.var_2043);
            this.var_2044 = false;
            this.var_2043 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_273,_loc7_));
         return true;
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1170:
                  break;
               case RoomSessionHandler.const_1098:
                  break;
               case RoomSessionHandler.const_745:
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_99,_loc4_));
            _loc4_.dispose();
         }
      }
