package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2120:String = "my_issues";
      
      private const const_2118:String = "open_issues";
      
      private const const_2119:String = "picked_issues";
      
      private const const_2178:String = "closed_issues";
      ...
      private var var_335:IIssueBrowserView;
      
      private var var_1624:IIssueBrowserView;
      
      private var var_1626:IIssueBrowserView;
      
      private var var_1625:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_242 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_242.numTabItems)
            {
               _loc5_ = this.var_242.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_242 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_242 == null || this.var_242.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_242.selector.getSelectableByName("open_issues");
         this.var_242.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_335 == _loc2_)
         {
            return;
         }
         if(this.var_335 != null)
         {
            this.var_335.visible = false;
         }
         this.var_335 = _loc2_;
         if(this.var_335 == null)
         {
         ...
         this.var_335.view.width = this.var_242.container.width;
         this.var_335.view.height = this.var_242.container.height;
         this.var_335.visible = true;
         this.var_335.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2120:
               ...
               {
                  this.var_1624 = new MyIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1624;
            case this.const_2118:
               if(this.var_1626 == null)
               {
                  this.var_1626 = new OpenIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1626;
            case this.const_2119:
               if(this.var_1625 == null)
               {
                  this.var_1625 = new PickedIssuesView(this.issueManager,this,this.var_242.container);
               }
