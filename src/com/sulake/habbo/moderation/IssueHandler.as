package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_546:UserInfoCtrl;
      
      private var var_1276:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_546 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_1276 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_546.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1276.load(_loc4_,this.var_169.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_64 != null && this.var_64.issueManager != null && this.var_169 != null)
         {
            this.var_64.issueManager.removeHandler(this.var_169.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_169.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_169.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_169.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.releaseBundle(this.var_169.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_64,WindowTracker.const_1288,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_546 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
            this.var_546.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
