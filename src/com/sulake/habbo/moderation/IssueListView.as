package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2991:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_638 = param2;
         this._list = param3;
         this.var_1731 = param4;
         this.var_1884 = this.var_638.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1884.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1884 == null)
            {
               return;
            }
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_638.assets.getAssetByName(_loc12_) as BitmapDataAsset;
