package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1221:int = 5;
      ...
      public static const const_1568:int = 9;
       
      
      private var var_1832:Dictionary;
      ...
      {
         var _loc2_:Dictionary = this.var_1832[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1832[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
