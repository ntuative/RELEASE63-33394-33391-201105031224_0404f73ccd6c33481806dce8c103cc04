package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_937:Array = [];
      
      private static var var_1781:int = 200;
      ...
      {
         this.var_760 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1721;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_937.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_760.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_937.length < var_1781)
         {
            ...
            param1.width = this.var_760.width;
            param1.height = this.var_760.height;
            var_937.push(param1);
         }
         else
         {
