package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1897:String = "no_reqs_info";
      ...
      private var var_1999:IContainerButtonWindow;
      ...
      {
         this.var_1999 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2000 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2000.procedure = this.method_11;
         this.var_1999.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_94,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_386)
         {
         ...
         else if(param1.state == FriendRequest.const_1184)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_386;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_354,param1));
         }
      }
      ...
      private function method_11(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_386 && _loc4_.state != FriendRequest.const_420)
            {
               _loc4_.state = FriendRequest.const_420;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_354,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_386 && _loc4_.state != FriendRequest.const_420)
            {
               ...
               _loc4_.state = FriendRequest.const_386;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1999,_loc1_);
         this.setEnabled(this.var_2000,_loc1_);
      }
