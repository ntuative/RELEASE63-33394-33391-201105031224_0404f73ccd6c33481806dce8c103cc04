package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_312:MainViewCtrl;
      
      private var var_440:RoomInfoViewCtrl;
      
      private var var_1231:RoomCreateViewCtrl;
      ...
      private var var_2997:Dictionary;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_312 = new MainViewCtrl(this);
         this.var_440 = new RoomInfoViewCtrl(this);
         this.var_1231 = new RoomCreateViewCtrl(this);
         this.var_2660 = new RoomThumbnailRenderer(this);
         this.var_992 = new GuestRoomPasswordInput(this);
         this.var_320 = new GuestRoomDoorbell(this);
         this.var_429 = new Tabs(this);
         this.var_1230 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_365,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_440.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_137,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_137,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_37)
         {
            ...
            {
               this.var_440.handleToolbarEvent(param1);
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_193.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_312.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_312.startSearch(Tabs.const_282,Tabs.const_431,param1);
         this.var_312.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_312.startSearch(Tabs.const_318,Tabs.const_270);
         this.var_429.getTab(Tabs.const_318).tabPageDecorator.tabSelected();
      }
