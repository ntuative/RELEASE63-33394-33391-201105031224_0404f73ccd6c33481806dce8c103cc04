package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_612:int = 10;
      
      private static const const_1064:int = 32;
      
      private static const const_1482:int = 8;
      
      private static const const_1484:int = -16;
      
      private static const const_1483:int = 40;
      ...
      private var var_1022:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_1022 = new ThumbnailImageConfigurations(this._navigator);
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1064 / 2);
         return new Point(param1 * const_1064 + _loc3_,param2 * const_1482);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_365,HabboWindowStyle.const_44,0 | (!!param3 ? HabboWindowParam.const_41 : HabboWindowParam.const_44),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      public function refreshBitmapContent(param1:BitmapData, param2:RoomThumbnailData) : void
      {
         ...
         this.method_12(param1,param2.frontImgId);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_1022.getImage(ThumbnailEditorModel.const_38,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_1022.getImage(ThumbnailEditorModel.const_38,1);
         }
         var _loc4_:BitmapData = _loc3_.getImg();
         param1.copyPixels(_loc4_,_loc4_.rect,new Point(0,0),null,null,true);
      }
      
      private function method_12(param1:BitmapData, param2:int) : void
      {
         if(param2 < 1)
         {
            return;
         }
         var _loc3_:ThumbnailImageConfiguration = this.var_1022.getImage(ThumbnailEditorModel.const_62,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1551 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1551,this.var_1551.rect,new Point(0,0),null,null,true);
      }
      
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_1022.getImage(ThumbnailEditorModel.const_36,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1484,_loc4_.y + const_1483 - _loc5_.height),null,null,true);
      }
