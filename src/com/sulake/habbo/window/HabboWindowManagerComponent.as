package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_452:uint = 3;
      
      private static const const_1352:uint = 1;
      ...
      private var var_1402:IEventDispatcher;
      
      private var var_1121:Boolean = false;
      
      private var var_1703:ProfilerOutput;
      
      private var var_1403:ProfilerAgentTask;
      
      private var var_1401:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_899 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_899);
         this.var_202 = new Array(const_452);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_452)
         {
            this.var_202[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_281 = this.var_202[const_1352];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1703)
            {
               this.var_1703 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1703.profiler = _loc3_;
            this.var_1403 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1403);
            this.var_1401 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1401);
            this.var_1121 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_202)
            {
               ...
               {
                  IDisposable(this.var_202.pop()).dispose();
               }
            }
            this.var_202 = null;
            if(this.var_251)
      ...
      {
         return this.var_281.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_281.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_899.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_202[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_202[param2].getDesktopWindow();
      ...
      {
         return this.var_202[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_202[param1].getDesktopWindow().getChildAt(this.var_281.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_202[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1402.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_452 - 1;
            while(_loc2_ >= 0)
            {
               this.var_202[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1121)
         ...
         this.var_1402.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_452)
         {
            this.var_202[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1121)
         {
         ...
         this.var_1402.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1727,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1791,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1540,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1829,param2.name + ": " + param2.toString());
            }
         }
      }
