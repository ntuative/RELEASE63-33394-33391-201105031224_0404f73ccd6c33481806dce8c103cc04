package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_300:Boolean = false;
      
      private static const const_667:String = "FriendBar";
      
      private static const const_668:String = "user_interaction";
      
      private static const const_1435:String = "visit_btn_click";
      
      private static const const_1438:String = "chat_btn_click";
      
      private static const const_1434:String = "find_friends_btn_click";
      
      private static const const_1047:String = "Toolbar";
      
      private static const const_1046:String = "open";
      
      private static const const_1045:String = "close";
      
      private static const const_1436:String = "FRIENDLIST";
      
      private static const const_1437:String = "MESSENGER";
       
      
      private var var_84:IHabboCommunicationManager;
      
      private var var_365:IHabboFriendList;
      
      private var var_431:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_365)
            {
               this.var_365.release(new IIDHabboFriendList());
               this.var_365 = null;
            }
            if(this.var_431)
            {
               this.var_431.release(new IIDHabboMessenger());
               this.var_431 = null;
            }
            this.var_138 = null;
      ...
      {
         return this.var_308.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_84)
         {
            ...
            this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_667,const_668,const_1435));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_431)
         {
            this.var_431.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_84)
            {
               this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_667,const_668,const_1438));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_84)
         {
            ...
            this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_667,const_668,const_1434));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         if(this.var_365)
         {
            ...
            {
               if(!this.var_365.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_365.openFriendRequests();
                  }
                  else
                  {
                     this.var_365.openFriendList();
                  }
               }
               else
               {
               ...
               if(this.var_84)
               {
                  this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1047,const_1436,!!this.var_365.isOpen() ? const_1046 : const_1045));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_431)
         {
            ...
            {
               this.var_431.toggleMessenger();
               if(this.var_84)
               {
                  this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1047,const_1437,!!this.var_431.isOpen() ? const_1046 : const_1045));
               }
            }
         }
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_308.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_308.remove(_loc8_);
               this.var_138.splice(this.var_138.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_308.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_300)
               {
               ...
               {
                  this.var_308.remove(_loc4_.id);
                  this.var_138.splice(this.var_138.indexOf(_loc3_),1);
               }
            }
            else if(_loc4_.online || const_300)
            {
               ...
               this.var_308.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_300)
            {
               if(this.var_308.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_138.push(_loc3_);
                  this.var_308.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_138 = !!const_300 ? this.sortByNameAndOnlineStatus(this.var_138) : this.sortByName(this.var_138);
         }
