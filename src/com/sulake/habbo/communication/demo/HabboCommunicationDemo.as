package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2424:PseudoRandom;
      ...
      private var var_222:HabboHotelView;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_621 = param1;
            this.var_55.initConnection(HabboConnectionType.const_254);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_99,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_55 && this.var_133 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_133.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_222 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_133.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_133.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_222.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_133.getKey("use.sso.ticket") == "1";
         this.var_621 = this.var_133.getKey("sso.ticket",null);
         this.var_1749 = this.var_133.getKey("flash.client.url","");
         this.var_2423 = this.var_133.getKey("external.variables.txt","");
         if(this.var_222 == null)
         {
            this.var_222 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_55.mode = HabboConnectionType.const_93;
            if(this.var_621)
            {
               this.var_55.initConnection(HabboConnectionType.const_254);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_55.mode = HabboConnectionType.const_93;
            if(this.var_133.keyExists("local.environment"))
            {
               this.var_55.mode = HabboConnectionType.const_1155;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_254);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_955);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2424 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_93:
               _loc6_ = "";
               _loc6_ = this.var_133.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_133.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1435 = _loc4_;
               this.var_222.loadBannerImage(_loc7_ + "?token=" + this.var_1435,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1155:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1669:
               this.var_919 = this.generateRandomHexString(30);
               this.var_504 = new DiffieHellman(new BigInteger(this.var_133.getKey("connection.development.prime"),16),new BigInteger(this.var_133.getKey("connection.development.generator"),16));
               this.var_504.init(this.var_919);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2424);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1749,this.var_2423));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1872,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_621 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_621);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2422)
         {
            _loc2_ = this.var_133.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2422 = true;
         var _loc2_:String = this.var_133.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_133.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
