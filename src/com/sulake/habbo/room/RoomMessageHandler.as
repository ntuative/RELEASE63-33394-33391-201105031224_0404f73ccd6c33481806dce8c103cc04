   ...
   public class RoomMessageHandler
   {
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new HeightMapMessageEvent(this.method_13));
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_847.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_847.objectData);
            this.var_847.objectData = null;
         }
         else
         {
            this.var_847.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_847.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_847.objectData = _loc6_;
         }
      }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_1182:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1200:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1240,_loc3_.status);
         }
      }
