package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_221:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_221 = this.var_599[param1];
               _loc3_ = true;
            }
            else if(param1 != var_87)
            {
               if(this.var_221)
               {
                  this.var_221.reset();
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_221)
         {
            this.var_221.setAnimation(param1);
         }
      ...
      {
         if(this.var_221 && this.var_221.controlsSprite(param3))
         {
            return this.var_221.getSpriteYOffset(param1,param2,param3);
         }
