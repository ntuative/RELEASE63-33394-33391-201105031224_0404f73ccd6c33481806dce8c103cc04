package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1604:int = 16777215;
      
      public static const const_1557:int = 13421772;
      
      private static const const_1010:int = 16777215;
      
      private static const const_1007:int = 13421772;
      
      private static const const_1009:int = 10066329;
      
      private static const const_1008:int = 10066329;
      
      public static const const_1661:int = 16777215;
      
      public static const const_1567:int = 13421772;
      
      public static const const_1636:int = 10066329;
      ...
      private var var_1595:String = null;
      
      private var _floorType:String = null;
      
      private var var_1597:String = null;
      
      private var var_2341:String = null;
      
      private var var_1129:uint = 16777215;
      
      private var var_2338:int = 255;
      
      private var var_2342:int = 255;
      
      private var var_2340:int = 255;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_299["null"] = false;
         this.var_299["null"] = true;
         this.var_299["null"] = true;
         this.var_299["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_139 != null)
         {
            ...
            {
               _loc4_ = this.var_139[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_139.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_139[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1243);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1210);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_237,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1604;
               }
               else
               {
                  _loc13_.color = const_1557;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_1537)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_120,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2020 + this.const_2127 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_345.length)
            {
               _loc11_ = this.var_613[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_345[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1713)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2340 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2342 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2338 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1706)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1440 || _loc3_.y != this.var_2339 || _loc3_.z != this.var_2336 || param1.scale != this.var_2343))
            {
               this.var_1440 = _loc3_.x;
               this.var_2339 = _loc3_.y;
               this.var_2336 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1111);
            if(_loc3_ != this.var_2341)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2341 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_904));
            if(_loc4_ != this.var_1129)
            {
               this.var_1129 = _loc4_;
               this.var_2340 = this.var_1129 & 255;
               this.var_2342 = this.var_1129 >> 8 & 255;
               this.var_2338 = this.var_1129 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1250));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_173 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_205);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_198);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_222);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_834));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_725));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_797));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_139[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_237 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_299["null"] || param2 != this.var_299["null"] || param3 != this.var_299["null"])
         {
            this.var_299["null"] = param1;
            this.var_299["null"] = param2;
            this.var_299["null"] = param3;
            this.var_345 = [];
            this.var_613 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_345;
         if(this.var_345.length == 0)
         {
            _loc6_ = this.var_139;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_345.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_237)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_299[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_345.push(_loc12_);
                        this.var_613.push(_loc9_);
                     }
                  }
               }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_497.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_139.length)
         {
            _loc3_ = this.var_139[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_497.maskCount)
         {
            _loc10_ = this.var_497.getMaskType(_loc8_);
            _loc11_ = this.var_497.getMaskLocation(_loc8_);
            _loc12_ = this.var_497.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_139.length)
               {
                  _loc3_ = this.var_139[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_120 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_283)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_139[_loc18_] as RoomPlane;
