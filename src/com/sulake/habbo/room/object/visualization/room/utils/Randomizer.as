package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2111:int = 1;
      
      public static const const_1967:int = 16777216;
      ...
      private var var_1754:int = 16777216;
      
      private var var_2944:int = 69069;
      
      private var var_2945:int = 5;
      ...
      {
         var _loc1_:int = this.var_2944 * this.var_1755 + this.var_2945;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1754;
         this.var_1755 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1754 * param2);
      }
   }
}
