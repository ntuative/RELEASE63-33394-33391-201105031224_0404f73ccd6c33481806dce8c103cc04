package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2996:String = "magic.credits";
      
      private var var_2959:String = "magic.pixels";
      
      private var var_2960:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2959);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2960,true);
      }
