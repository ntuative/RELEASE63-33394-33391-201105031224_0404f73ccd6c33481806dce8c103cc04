package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1452:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1520:XML;
      
      private static var var_1519:XML;
       
      
      private var var_1934:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1934 == 4294967295)
            {
               this.var_1934 = _loc1_.color;
            }
            _loc1_.color = const_1452;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1574;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1716;
            }
         }
      }
      ...
      {
         this._list = navigator.catalog.windowManager.buildFromXML(var_1519) as IItemListWindow;
         if(this._list == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1520) as IWindowContainer;
         }
         else
         {
