package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1005:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_249:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1005).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1005).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_84,MouseCursorType.const_770);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_770);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_249.select(this);
            this.var_602 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_602 != null && this.var_602 == param2)
         {
            _loc3_ = this.var_249.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_602 = null;
            }
