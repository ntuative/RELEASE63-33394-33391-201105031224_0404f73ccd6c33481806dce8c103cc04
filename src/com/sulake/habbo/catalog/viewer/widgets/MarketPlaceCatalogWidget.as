package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1875:int = 1;
      
      private const const_1876:int = 2;
      
      private const const_2138:int = 40;
      
      private const const_2137:int = 10;
      ...
      private var var_626:IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_507)
         {
            this.var_507.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_507 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_761 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_761 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_761));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_626)
         {
            ...
            this.var_626 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_626)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1876,_loc2_.length);
         if(!this.var_507)
         {
            this.var_507 = new Timer(25);
            this.var_507.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1167 = 0;
         this.populateList();
         this.var_507.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1167 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1167));
            ++this.var_1167;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_626 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_626.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1875);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_761.length)
         {
            _loc4_ = this.var_761[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_107)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2137;
                  break;
               case "search_input":
                  _loc8_ = this.const_2138;
                  break;
               default:
                  return;
            }
