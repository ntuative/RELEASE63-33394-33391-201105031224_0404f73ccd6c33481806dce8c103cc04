package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1198 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1858 = new Point(this.var_83.x,this.var_83.y);
         ...
         this.var_1857 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1198.text = _loc5_;
         this.var_964.height = this.var_964.textHeight + 5;
         this.var_1198.y = this.var_964.y + this.var_964.height;
         this.var_1198.height = Math.max(130,this.var_1198.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_644:
                  _loc6_ = this.var_1857.clone();
                  if(this.var_517 != null)
                  {
                     this.var_517.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_517,this.var_1485,this.var_1751);
                     ...
                     case ProductTypeEnum.const_209:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_353,AvatarAction.const_557);
                              _loc16_.appendAction(AvatarAction.const_327,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2574)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1858.x;
            this.var_83.y = this.var_1858.y;
            if(param3 != null)
            {
