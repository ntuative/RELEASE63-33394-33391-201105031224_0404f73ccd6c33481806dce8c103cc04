package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2163:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_99,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_565,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_52.getValue(InventoryCategory.const_81));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_52.getValue(InventorySubCategory.const_344));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_52.getValue(InventoryCategory.const_949));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_52.getValue(InventoryCategory.const_329));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_52.getValue(InventoryCategory.const_387));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_52.getValue(InventoryCategory.const_147));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_52.getValue(InventoryCategory.const_382) as MarketplaceModel;
      }
      ...
      {
         this.var_388 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_99,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_565,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               this._roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_565:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_388 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_52.add(InventoryCategory.const_382,_loc1_);
         ...
         this.var_52.add(InventoryCategory.const_81,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_388);
         this.var_52.add(InventoryCategory.const_329,_loc3_);
         ...
         this.var_52.add(InventoryCategory.const_949,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_388);
         this.var_52.add(InventoryCategory.const_387,_loc5_);
         ...
         this.var_52.add(InventorySubCategory.const_344,_loc6_);
         ...
         this.var_52.add(InventoryCategory.const_147,_loc8_);
         this.var_195 = true;
         if(this.var_2768)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1016.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1016.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1016.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1016.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2163);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_826));
      }
