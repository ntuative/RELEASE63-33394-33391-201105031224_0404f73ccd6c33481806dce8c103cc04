package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_708:BitmapData;
      
      protected var var_2778:int;
      
      protected var var_1620:Boolean;
      
      protected var var_2152:Boolean;
      
      protected var var_2934:BitmapData;
      
      private const const_2133:int = 8947848;
      
      private const const_2134:int = 13421772;
      
      private const const_1899:Number = 1;
      
      private const const_1898:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2935 == FurniModel.const_46)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1441));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2144);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_744)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1898;
               _loc1_.blend = this.const_1898;
            }
            else
            {
               this._window.blend = this.const_1899;
               _loc1_.blend = this.const_1899;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2152 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2934;
               _loc5_.visible = true;
            }
            else
            {
