package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2177:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_1058.length)
         {
            if(this.var_1058[_loc2_] == param1)
            {
               this.var_1058.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_388.getBadgeImage(param1);
      ...
      {
         if(param1 == InventoryCategory.const_329 && this._controller.isVisible)
         {
