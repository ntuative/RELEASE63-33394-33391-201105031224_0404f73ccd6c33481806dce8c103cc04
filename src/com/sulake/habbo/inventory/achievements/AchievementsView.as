package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_422 = new Timer(1000,1);
         this.var_422.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_388.events.addEventListener(BadgeImageReadyEvent.const_167,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_422)
            {
               this.var_422.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_422.reset();
               this.var_422 = null;
            }
            this._disposed = true;
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         _loc4_.text = this._localization.getAchievementDesc(param2.badgeId,param2.method_8);
         _loc4_.visible = true;
         ...
         this._localization.registerParameter(_loc6_,"scorelimit","" + param2.method_8);
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_422.running);
         this.var_1160[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1160[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_388.getBadgeImage(param2.badgeId);
            this.var_1160[param2.badgeId] = _loc4_;
         }
