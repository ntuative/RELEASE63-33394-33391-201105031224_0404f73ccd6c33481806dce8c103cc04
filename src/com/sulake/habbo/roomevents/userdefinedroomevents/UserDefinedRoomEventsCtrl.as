package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_328:int = 3;
      
      private static var var_1384:int = 2;
      ...
      private var var_1683:TriggerConfs;
      
      private var var_1685:ActionTypes;
      
      private var var_1684:ConditionTypes;
      
      private var var_247:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_728:RoomObjectHightLighter;
      
      private var var_118:UserDefinedRoomEventsHelp;
      
      private var var_1114:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1683 = new TriggerConfs();
         this.var_1685 = new ActionTypes();
         this.var_1684 = new ConditionTypes();
         this.var_247 = new Dictionary();
         super();
         this.var_78 = param1;
         this.var_728 = new RoomObjectHightLighter(param1);
         this.var_118 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1114 = new SliderWindowController(this.var_78,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_78.assets,0,20,1);
         this.var_1114.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1114.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_728.hideAll(this.var_247);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_728.showAll(this.var_247);
         if(this.var_35 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_35);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1114.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_35.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_328)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1114.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_118.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1384) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1384 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_328)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1685);
