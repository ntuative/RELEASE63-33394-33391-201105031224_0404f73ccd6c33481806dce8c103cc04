package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1381:String = "increment";
      
      private static const const_1382:String = "decrement";
      
      private static const const_1023:String = "slider_track";
      
      private static const const_658:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_702:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_175 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_647;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_596,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_596,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_1023) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_658) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_658:
               if(param2.type == WindowEvent.const_216)
               {
                  if(!this.var_1164)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_591)
         {
            if(this.var_17 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_352)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_702;
                  }
                  else
                  {
                     this.scrollV -= this.var_702;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_867)
         {
            ...
            else if(param2.name == const_1382)
            {
               if(this.var_17)
               {
                  this.var_1164 = true;
            ...
            else if(param2.name == const_1023)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_658).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_352)
         {
