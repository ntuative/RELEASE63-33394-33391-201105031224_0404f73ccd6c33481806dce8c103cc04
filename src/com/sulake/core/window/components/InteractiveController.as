package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_532)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_532)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_713,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1776);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1109)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_707,param1.toolTipDelay,PropertyStruct.const_264,true));
         }
         else
         {
      ...
      {
         this.var_1347 = param1 == null ? "null" : param1;
      }
