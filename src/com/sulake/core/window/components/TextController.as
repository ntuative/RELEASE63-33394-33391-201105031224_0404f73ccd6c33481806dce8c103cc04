package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1320:Dictionary = createPropertySetterTable();
      ...
      protected var var_1085:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_439,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_439 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_439,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_217);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_751 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_874 * this.maxScrollH,this.var_572 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_828,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1114));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1202 ? new PropertyStruct(PropertyDefaults.const_730,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1137) : PropertyDefaults.const_1679);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_264,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1225 ? new PropertyStruct(PropertyDefaults.const_1310,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1316) : PropertyDefaults.const_1814);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_700) ? new PropertyStruct(PropertyDefaults.const_429,this._field.textColor,PropertyStruct.const_161,true) : PropertyDefaults.const_1271);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_817 ? new PropertyStruct(PropertyDefaults.const_258,this.var_40.left,PropertyStruct.const_43,true) : PropertyDefaults.const_566);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_870 ? new PropertyStruct(PropertyDefaults.const_286,this.var_40.top,PropertyStruct.const_43,true) : PropertyDefaults.const_537);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_937 ? new PropertyStruct(PropertyDefaults.const_275,this.var_40.right,PropertyStruct.const_43,true) : PropertyDefaults.const_618);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_742 ? new PropertyStruct(PropertyDefaults.const_250,this.var_40.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_482);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1087 ? new PropertyStruct(PropertyDefaults.const_983,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1761);
