package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2133:Boolean = false;
      
      protected var var_570:Boolean = false;
      ...
      protected var var_2131:int = 0;
      
      protected var var_1334:Number;
      
      protected var var_1332:Number;
      
      protected var var_1333:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_108 = 0;
         this.var_95 = 0;
         this._horizontal = param2 == WindowType.const_397;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_175 = var_479 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_405,WindowStyle.const_135,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_39,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_393,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_700 * this.maxScrollH,this.var_698 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_698 = param1;
            this._container.y = -this.var_698 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_596,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_592,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_393,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_196:
               if(this.var_1333)
               {
                  this.var_1334 = this.var_2132 - _loc3_;
                  this.var_1332 = this.var_2131 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1334 != 0 && this.var_108 != 0)
                     {
                        this.scrollH += this.var_1334 / this.var_108;
                     }
                  }
                  else if(this.var_1332 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1332 / this.var_95;
                  }
                  this.var_2132 = _loc3_;
                  this.var_2131 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_208:
               if(this.var_1333)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1334,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1332);
                  }
                  this.var_1333 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1079 && !this.var_570 && this._container)
         {
            this.var_570 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_773)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_384,this._spacing,PropertyStruct.const_43,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1255);
         }
         if(this.var_1079 != PropertyDefaults.const_1133)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_944,this.var_1079,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1731);
         }
         if(this.var_473 != PropertyDefaults.const_1262)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_948,this.var_473,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1693);
         }
         if(this.var_1335 != PropertyDefaults.const_1188)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_971,this.var_1335,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1733);
         }
         if(this.var_699 != PropertyDefaults.const_1130)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_896,this.var_699,PropertyStruct.const_124,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1592);
         }
         if(this.var_701 != PropertyDefaults.const_1191)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_838,this.var_701,PropertyStruct.const_124,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_838:
                  this.var_701 = _loc2_.value as Number;
                  break;
            }
         }
