package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1324:String = "_TITLE";
      
      private static const const_1466:String = "_HEADER";
      
      private static const const_1464:String = "_CONTENT";
      
      private static const const_1465:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1539:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1324) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1539 = findChildByTag(const_1466) as IHeaderWindow;
            if(!this.var_1539)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_178 = findChildByTag(const_1464) as IWindowContainer;
            if(!this.var_178)
            {
      ...
      {
         return findChildByTag(const_1465) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1321,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1075 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_332);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_245);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_289);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_289,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_289,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_340,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_258,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_286,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_275,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_250,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
