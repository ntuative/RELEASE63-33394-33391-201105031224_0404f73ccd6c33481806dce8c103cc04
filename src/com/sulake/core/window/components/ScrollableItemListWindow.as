package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1223:IItemListWindow;
      
      private var var_437:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_437)
         {
            this.var_437.removeEventListener(WindowEvent.const_244,this.scrollBarEventProc);
            this.var_437.removeEventListener(WindowEvent.const_201,this.scrollBarEventProc);
            this.var_437 = null;
         }
         if(this.var_1223)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1223)
         {
            this.var_1223 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_437)
         {
            this.var_437 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_437)
            {
               this.var_437.addEventListener(WindowEvent.const_244,this.scrollBarEventProc);
               this.var_437.addEventListener(WindowEvent.const_201,this.scrollBarEventProc);
            }
         }
         return this.var_437;
      }
