package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1347 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1119,var_11);
         }
         return var_21;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_181,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_406,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_698,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1623);
         _loc1_.push(this.var_1329 != PropertyDefaults.const_1112 ? new PropertyStruct(PropertyDefaults.const_792,this.var_1329,PropertyStruct.const_40,true) : PropertyDefaults.const_1686);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1300 ? new PropertyStruct(PropertyDefaults.const_812,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1732);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1209 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1768);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_792:
                  this.var_1329 = _loc2_.value as Boolean;
                  if(this.var_1329)
                  {
               ...
               case PropertyDefaults.const_698:
                  ...
                  break;
               case PropertyDefaults.const_1185:
