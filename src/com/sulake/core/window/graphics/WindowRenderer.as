package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1901 = new Point();
         this.var_1503 = new Rectangle();
         this.var_310 = new Rectangle();
         this.var_370 = new Dictionary(true);
         this.var_899 = param1;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_310.x = param2.x - param1.x;
            this.var_310.y = param2.y - param1.y;
            this.var_310.width = param2.width;
            this.var_310.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_34))
            {
               while(param1.testParamFlag(WindowParam.const_34))
               {
                  ...
                  this.var_310.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_310,WindowRedrawFlag.const_1125);
            if(this.var_799.indexOf(param1) == -1)
            {
      ...
      {
         var _loc2_:WindowRendererItem = this.var_370[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_370[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_899);
            this.var_370[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_866,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_866,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_370[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_370[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_799.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_799.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_310.x = _loc3_.dirty.x;
               this.var_310.y = _loc3_.dirty.y;
               this.var_310.width = _loc3_.dirty.width;
               this.var_310.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_310,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1901,this.var_1503))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1901,this.var_1503))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_34))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1503);
