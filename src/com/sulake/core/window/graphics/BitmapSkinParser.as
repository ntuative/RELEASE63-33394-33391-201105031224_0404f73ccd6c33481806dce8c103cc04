   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_398 = SkinLayoutEntity.const_489;
                  break;
               case "move":
                  _loc5_.var_398 = SkinLayoutEntity.const_311;
                  break;
               case "strech":
                  _loc5_.var_398 = SkinLayoutEntity.const_604;
                  break;
               case "tiled":
                  _loc5_.var_398 = SkinLayoutEntity.const_341;
                  break;
               case "center":
                  _loc5_.var_398 = SkinLayoutEntity.const_1103;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_399 = SkinLayoutEntity.const_489;
                  break;
               case "move":
                  _loc5_.var_399 = SkinLayoutEntity.const_311;
                  break;
               case "strech":
                  _loc5_.var_399 = SkinLayoutEntity.const_604;
                  break;
               case "tiled":
                  _loc5_.var_399 = SkinLayoutEntity.const_341;
                  break;
               case "center":
                  _loc5_.var_399 = SkinLayoutEntity.const_1103;
            }
         }
