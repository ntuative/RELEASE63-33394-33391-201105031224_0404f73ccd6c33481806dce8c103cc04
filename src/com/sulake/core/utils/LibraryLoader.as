package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1836:uint = 1;
      
      protected static const const_1838:uint = 2;
      
      protected static const const_1837:uint = 4;
      ...
      private static var var_885:Array = new Array();
      
      private static var var_715:Array = new Array();
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_43.load(param1.var_238,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1282)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_715[_loc2_] as LibraryLoader;
            ...
            while(var_715.length < const_1792 && false)
            {
               _loc1_ = var_885.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_715.push(_loc1_);
                  _loc1_.var_43.load(_loc1_.var_238,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1075 ? uint(this.var_1330 - this.var_2130) : uint(getTimer() - this.var_2130);
      }
      ...
      public function resume() : void
      {
         ...
         {
            this.var_1076 = false;
            if(!this.var_1075 && this.var_238)
            {
               this.var_1330 = -1;
               this.var_2130 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1075 && !_disposed && this.var_1331 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_238,const_1577 - this.var_1331);
            if(this.var_2916)
            {
            ...
            --this.var_1331;
            this.var_472 = 0;
            this.var_43.load(this.var_238,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_472 = LibraryLoader.name_4;
         ...
         if(this.var_472 == LibraryLoader.const_1835)
         {
         ...
         if(this.var_472 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_665 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_665.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
