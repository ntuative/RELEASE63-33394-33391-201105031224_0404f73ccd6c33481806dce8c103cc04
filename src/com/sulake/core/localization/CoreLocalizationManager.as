package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.getLocalizationDefinition(this.var_2872);
      }
      ...
      {
         var _loc3_:Localization = this.var_60[param1] as Localization;
         if(_loc3_ == null)
         {
            this.var_1307.push(param1);
            return param2;
         }
         return _loc3_.value;
      }
      ...
      {
         var _loc3_:Localization = this.var_60[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_60[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_2068);
         }
      }
      ...
      {
         var _loc5_:Localization = this.var_60[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_60[param1] = _loc5_;
         }
      ...
      {
         return this.var_60[param1] as ILocalization;
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_60)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_2068);
            }
         }
      }
   }
