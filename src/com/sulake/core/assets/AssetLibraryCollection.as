package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_574:Array;
      
      protected var var_1078:LoaderContext;
      
      protected var var_477:AssetLibrary;
      
      protected var _manifest:XML;
      
      protected var _name:String;
      
      private var var_580:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1078 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_477 = new AssetLibrary("lib-" + this.var_580++);
         this.var_29.push(this.var_477);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1078;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_580++);
      ...
      {
         return this.var_477.loadFromResource(param1,param2);
      }
      
      public function unload() : void
      {
         while(this.var_574.length > 0)
         {
            (this.var_574.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_574.length)
            {
               _loc3_ = this.var_574[_loc4_] as IAssetLibrary;
      ...
      {
         return this.var_477.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_477.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_477.createAsset(param1,param2);
      }
      ...
      {
         return this.var_477.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_477.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_477.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_477.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
