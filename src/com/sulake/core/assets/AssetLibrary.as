package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1287:String = "AssetLibraryReady";
      
      public static const const_918:String = "AssetLibraryLoaded";
      
      public static const const_1646:String = "AssetLibraryUnloaded";
      
      public static const const_1780:String = "AssetLibraryLoadError";
      
      private static const const_465:String = "name";
      
      private static const const_1055:String = "asset";
      
      private static const const_1057:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1056:String = "library";
      
      private static var var_317:Dictionary;
      
      private static var var_1957:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_536:uint = 0;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_536;
         this.var_446 = new Dictionary(false);
         this.var_537 = new Dictionary(false);
         this.var_1003 = new Dictionary(false);
         this.var_165 = new Dictionary(false);
         var_1006.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_664 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1056);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1055);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_465);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1057);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_664 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_664 == param1.url && this.var_1005)
         {
            if(!this.var_1004 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_665);
            }
      ...
      public function unload() : void
      {
         ...
         this.var_1005 = false;
         this.var_664 = null;
         dispatchEvent(new Event(AssetLibrary.const_1646));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_537[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1205,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1309,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1142,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1304,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_537[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_537[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_165[struct.assetName] == null)
                  {
                     ++this.var_445;
                     this.var_447.push(struct.assetName);
                  }
                  this.var_165[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_537[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_165[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_447.length ? this.getAssetByName(this.var_447[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_165)
         {
            if(this.var_165[_loc2_] == param1)
            {
               return this.var_447.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_165[param1] != null || (this.var_665 != null ? this.var_665[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_165[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1957.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_165)
            {
               if(this.var_165[_loc2_] == param1)
               {
                  this.var_447.splice(this.var_447.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_317.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_317[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_446.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_446[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_317[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_446[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_317)
            {
               _loc3_ = AssetTypeDeclaration(var_317[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_446)
         {
            _loc3_ = AssetTypeDeclaration(this.var_446[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_317)
            {
               _loc4_ = AssetTypeDeclaration(var_317[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_446)
         {
            _loc4_ = AssetTypeDeclaration(this.var_446[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_665 = _loc2_.resource;
         this.var_664 = _loc2_.url;
         if(this.var_1004)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_665);
         }
         this.var_1005 = true;
         dispatchEvent(new Event(AssetLibrary.const_918));
         dispatchEvent(new Event(AssetLibrary.const_1287));
         if(this.var_1004)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1780));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1056);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1055);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_465).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_664 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_665[param1]);
                  _loc6_ = _loc3_.child(const_1057);
                  if(_loc6_.length())
                  {
