package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1078 = new LoaderContext();
         this.var_1078.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1078);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_330 = 0;
         this.var_43.load(param1,this.var_1078);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_330 < var_2927)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1077 + (this.var_1077.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_330),this.var_1078);
               return true;
            }
         }
         return false;
